...
register_kill( var_0, var_1, var_2, var_3 )
{
    ...
    var_6 = level.player getplayerdata( common_scripts\utility::_id_AC0E(), "career", "kills_total" );

    println(var_4.stats["kills"]);
    println("TOTAL KILLS CAREER: " + var_6);

    if ( isdefined( var_6 ) )
        level.player setplayerdata( common_scripts\utility::_id_AC0E(), "career", "kills_total", var_6 + 1 );
...
shots_fired_recorder()
{
    ...
    for (;;)
    {
        ...
        println(self.stats["shots_fired"]);
