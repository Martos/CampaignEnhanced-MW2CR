...
setskill( var_0 )
{
    ...
    level.difficultysettings["player_downed_buffer_time"]["easy"] = 2;
...
playerhealthregen()
{
    ...
    for (;;)
    {
        ...
        {
            if ( isdefined( level._id_A87F._id_C1BB ) && level._id_A87F._id_C1BB )
                continue;
        ...
        var_0 = var_7;
        var_11 = self.gs.worthydamageratio;
...
_id_C343()
{
    ...
    for (;;)
    {
        if ( isdefined( level._id_C6A9 ) && level._id_C6A9 )
        {
            var_0.color = ( 0.0, 0.0, 0.0 );
            var_0.alpha = 0;
            wait(var_3);
...
_id_BA24( var_0 )
{
    ...
    for (;;)
    {
        var_0 scaleovertime( var_2, var_0._id_BC2F, var_0._id_AA7E );
        var_0 fadeovertime( var_5 );
        var_0.alpha = var_7;
        wait(var_10);
        var_0 scaleovertime( var_1, var_0._id_C271, var_0._id_C3A3 );
...
softpulseoverlay( var_0 )
{
    ...
    var_0 scaleovertime( var_4, var_0._id_BC2F, var_0._id_AA7E );
    var_0 fadeovertime( var_5 );
    var_0.alpha = 0;
    wait(var_12 + var_11);
    self playlocalsound( var_13 );
...
_id_D0D4( var_0 )
{
    ...
    if ( isdefined( level.dosoftpulseoverlay ) && level.dosoftpulseoverlay )
        ...
        thread _id_BA24( var_0 );

    thread _id_CBEF( var_0 );
